...
static const int MIN_PEER_PROTO_VERSION = 62105; // When editing Block_reorg in main.h, always make it a mandatory fork! ~ SaltineChips
...
static const int NOBLKS_VERSION_END = 62101;
