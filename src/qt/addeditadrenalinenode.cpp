    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 2,750,000 KONJ TXID");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (123.45.67.89:19417)");
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the transaction that has 2,750,000 coins");
        msg.exec();
        return;
    }
